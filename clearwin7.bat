...
echo 把补丁卸载文件夹的名字保存成ghostsf.txt 

dir %windir%\$NtUninstall* /a:d /b >%windir%\ghostsf.txt 

echo 从ghostsf.txt中读取文件夹列表并且删除文件夹 

for /f %%i in (%windir%\ghostsf.txt) do rd %windir%\%%i /s /q 

echo 删除ghostsf.txt 

del %windir%\ghostsf.txt /f /q 
